...
// Continent Continent Continent holds continent and regions of a cloud provider
// swagger:model Continent
...
func (m *Continent) validateRegions(formats strfmt.Registry) error {

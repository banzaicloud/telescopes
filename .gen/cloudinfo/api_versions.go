...
/*
VersionsApiService Provides a list of available versions on a given provider in a specific region for a service.
...
*/
func (a *VersionsApiService) GetVersions(ctx context.Context, provider string, service string, region string) (VersionsResponse, *http.Response, error) {
	var (

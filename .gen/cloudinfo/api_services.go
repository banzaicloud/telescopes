...
*/
func (a *ServicesApiService) GetServices(ctx context.Context, provider string) (ServicesResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/providers/{provider}/services"

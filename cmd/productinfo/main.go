...
import (
	...
	"github.com/banzaicloud/telescopes/internal/app/productinfo/api"
	"github.com/banzaicloud/telescopes/pkg/productinfo"
	"github.com/banzaicloud/telescopes/pkg/productinfo/azure"
	"github.com/banzaicloud/telescopes/pkg/productinfo/ec2"
	"github.com/banzaicloud/telescopes/pkg/productinfo/gce"
...
func defineFlags() {
	...
	flag.StringSlice(providerFlag, []string{Ec2, Gce, Azure}, "Providers that will be used with the recommender.")
...
func main() {
	...
	routeHandler := api.NewRouteHandler(productInfo)
